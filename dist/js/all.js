...
function generateArticleIcon() {
	...
	var iconArrJapan = ["unagi-nigiri", "udon", "nigiri", "ikura-gunkan-maki", "okonomiyaki"];

	var iconArrIndo = ["backpack", "horse", "palm-trees", "surf", "volcano", "beach", "sea", "summer"];
...
$(document).ready(function () {
	...
	if ($('article').length) {
		...
		$('article').imagesLoaded().progress(function (instance, image) {
